// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.5.0-323.1.beta.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var msg, result,
        t1 = type$.JSObject,
        $self = t1._as(self),
        subWorker = t1._as(new $self.Worker("sub_worker.js")),
        sab = t1._as(new $self.SharedArrayBuffer(4)),
        t2 = type$.JavaScriptFunction._as($self.Int32Array);
      t1 = type$.NativeInt32List._as(A.callConstructor(t2, [sab], t1));
      msg = {type: 2, data: sab};
      msg._isWorkerMessage = true;
      subWorker.postMessage(msg);
      t1 = new A.main_closure(t1, $self);
  ...
  A.main_closure.prototype = {
    call$1(message) {
      var t2, msg,
        t1 = type$.JSObject;
      switch (A._asInt(t1._as(type$.Object._as(t1._as(message).data)).type)) {
        case 1:
          t1 = self;
          t2 = this.int32array;
          A._asString(t1.Atomics.wait(t2, 0, 0));
          msg = {type: 3, data: A._asInt(t1.Atomics.load(t2, 0))};
          msg._isWorkerMessage = true;
...
//# sourceMappingURL=main_worker.js.map

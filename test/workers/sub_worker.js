...
(function dartProgram() {
  ...
  A.main_closure.prototype = {
    call$1(message) {
      var sab, t2, t3, t4,
        t1 = type$.JSObject,
        msg = t1._as(type$.Object._as(t1._as(message).data)),
        msg0 = {type: 1};
      msg0._isWorkerMessage = true;
      this.self.postMessage(msg0);
      sab = t1._as(msg.data);
      t2 = this._box_0;
      t2.sab = sab;
      t3 = self;
      t4 = type$.JavaScriptFunction._as(t3.Int32Array);
      t1 = type$.NativeInt32List._as(A.callConstructor(t4, [sab], t1));
      t2.int32array = t1;
      A._asInt(t3.Atomics.store(t1, 0, 6));
      A._asInt(t3.Atomics.notify(t2.int32array, 0));
    }
  };
  (function aliases() {
...
//# sourceMappingURL=sub_worker.js.map
